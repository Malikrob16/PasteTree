  ...
  <aside class="aside">
    <nav aria-label="Main navigation" class="aside-container">
      <ul>
        ...
        <li class="aside-nav-item" data-label="Explore" ><a href="#"><svg aria-hidden="true" fill="#000000" width="50px" height="50px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
